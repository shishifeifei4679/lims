...
// 导出url
export const exportUrl = `${limsUrl}limsMeasuringToolsCollectReturn/pageCollectReturn/export`
// 分页查询
export function getList(params = {}) {
  return request({
    url: `${limsUrl}limsMeasuringToolsCollectReturn/pageCollectReturn`,
...
// 领用
export function applyCollect(data = {}) {
  return request({
    url: `${limsUrl}limsMeasuringToolsCollectReturn/apply/collect`,
    method: 'post',
    data,
  });
}
...
export function applyReturn(data = {}) {
  return request({
    url: `${limsUrl}limsMeasuringToolsCollectReturn/apply/return`,
    method: 'post',
    data,
  });
}
// 领用归还记录-分页查询
export function getCollectReturnLogList(params = {}) {
  return request({
...
export function listLog(params = {}) {
  return request({
    url: `${limsUrl}limsMeasuringToolsCollectReturn/listLog`,
    method: 'get',
    params,
  });
}
// 记录-分页查询
export function jilulistLog(params = {}) {
  return request({
