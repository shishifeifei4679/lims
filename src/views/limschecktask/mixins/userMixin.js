...
export const baseUserDialog = {
  data() {
    return {
      ...
      baseUserSearchDialog: {
        ...
        formDesc: {
          nickName: {
            type: "input",
            layout: 8,
            label: $i18n.t("checkTask.nickName"),
          },
        },
      },
      baseUserDialogColumn: [
        ...
        // {
        //   prop: "tenantCode",
        //   label: $i18n.t("checkTask.tenantCode"),
        //   showOverflowTooltip: true,
        // },
        {
          prop: "jobNumber",
          label: $i18n.t("checkTask.jobNumber"),
          showOverflowTooltip: true,
        ...
        {
          prop: "email",
          label: $i18n.t("checkTask.email"),
          showOverflowTooltip: true,
        },
        {
          prop: "mobile",
          label: $i18n.t("checkTask.mobile"),
          showOverflowTooltip: true,
        },
      ],
    };
  ...
  methods: {
    ...
    //   this.$set(this.form, "defaultCheckerId", data[0].userId);
    //   this.$set(this.form, "defaultCheckerNumber", data[0].jobNumber);
    //   this.$set(this.form, "defaultChecker", data[0].nickName);
    // },
  },
};
