import {
  getCheckRecordsList as getCheckRecordsListRight,
...
export const measuringToolsCheckLogDialogRight = {
  data() {
    return {
      checkRecordsVisible: false, //表格弹框隐藏显示
      getCheckRecordsListRight, // 获取弹框数据接口
      ...
      checkRecordsDialogColumnRight: [
        ...
        },
        {
          ...
          label: $i18n.t(
            "measuringtoolsoutsourcingcheck.verificationCertificateCode"
          ), // 检定证书编码
          width: 120,
          showOverflowTooltip: true,
          showColumnSearch: true,
