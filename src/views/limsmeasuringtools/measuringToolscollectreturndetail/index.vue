  ...
  <div>
    <div>
      <ele-page
        ...
        :column="column"
        :getList="getList"
        uniqueId="limsMeasuringToolsCollectReturnDetailTable"
      >
      </ele-page>
    </div>
    ...
    return {
      ...
      column: [
        ...
        },
        {
          ...
          label: $i18n.t('limsMeasuringToolsCollectReturnDetail.measuringToolCode'),  // 量检具编码
          width: '120',
          showOverflowTooltip: true,
          showColumnSearch: true,
          showColumnSearchConfig: { // 非必填 对象{} 不设置，就是默认模糊搜索
        ...
        },
        {
          ...
          label: $i18n.t('limsMeasuringToolsCollectReturnDetail.measuringToolName'),  // 量检具名称
          width: '150',
          showOverflowTooltip: true,
          showColumnSearch: true,
          showColumnSearchConfig: { // 非必填 对象{} 不设置，就是默认模糊搜索
