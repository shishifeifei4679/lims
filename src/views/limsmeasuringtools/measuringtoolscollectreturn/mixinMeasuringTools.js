...
export const measuringToolsDialog = {
  data() {
    return {
      collectMeasuringToolsVisible: false, //表格弹框隐藏显示
      returnMeasuringToolsVisible: false, //表格弹框隐藏显示
      ...
      measuringToolsDialogColumn: [
        ...
        {
          prop: "measuringRange",
          label: $i18n.t('limsMeasuringToolsLedgerCollectReturn.measuringRangeCode'),  // 测量范围
          width: "120",
          showOverflowTooltip: true,
          showColumnSearch: true,
        },
...
//        },
  ...
  methods: {
    ...
    setSelectMeasuringTools(data) {
      ...
      let list = [
        ...(this.collectFormDataDialog?.detailList ?? []),
        ...data.map((ite) => {
          return {
            ...ite
          }
      ...
      // 筛选重复值,插入
      this.$set(this.collectFormDataDialog, "detailList", uniqueKey(list, "measuringToolCode"))

      let list1 = [
        ...(this.returnFormDataDialog?.detailList ?? []),
        ...data.map((ite) => {
          return {
            ...ite
          }
      ...
      this.$set(this.returnFormDataDialog, "detailList", uniqueKey(list1, "measuringToolCode"))
    }
  }
}
